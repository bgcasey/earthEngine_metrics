...
Code that can be used to extract various metrics to point count locations using Google Earth Engine. The code should be used with earth engine's online code editor.
